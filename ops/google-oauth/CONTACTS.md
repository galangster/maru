# Google OAuth contact roster

Keep these addresses current in the production Google Cloud project and the annual evidence package. The production project requires two durable owners and current owner, editor, support, and developer contacts. Sources: `docs/research/shared-client-implementation-plan.md` Part 2 §4 and `wayfinder/NICK-QUEUE.md:12-17`.
...
Review this roster before submission, at each annual cycle, and after any personnel or mailbox change. Source: `docs/research/shared-client-implementation-plan.md` Part 1 §5.
