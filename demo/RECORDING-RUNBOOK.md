...
- [ ] The **0.1.7 signed build** is installed from the macos-release CI
  artifact (not a dev build). Verify About shows 0.1.7.
...
| --- | --- | --- |
| 01-build-and-version | Open the app, open About: name + 0.1.7 visible | — |
