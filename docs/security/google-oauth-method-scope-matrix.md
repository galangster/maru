...
Maru does not call Gmail draft, insert, import, or permanent-delete methods. Its implemented mutations use labels, Trash, untrash, and send. Source: `src/core/gmail/api.ts:239-409`.
