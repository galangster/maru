# Connect Wren to Gmail — one-time Google setup

Wren talks directly to the Gmail API with credentials that belong to *you*.
...
Google expires refresh tokens after 7 days — Wren will ask you to sign in
...
100 users can stay unverified indefinitely. Wren surfaces re-auth cleanly
either way.
